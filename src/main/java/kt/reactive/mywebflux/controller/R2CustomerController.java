...
public class R2CustomerController {
    ...
    public R2CustomerController(R2CustomerRepository customerRepository) { this.customerRepository = customerRepository;
    ...
    public Mono<Customer> saveCustomer(@RequestBody Customer customer) {
        ...
        return customerRepository.save(customer).doOnNext(savedCustomer -> sinksMany.tryEmitNext(savedCustomer)).log();
    }
